...
-Dappdynamics.agent.accountName=system
...
$cmd -Dappdynamics.agent.tierName=$service1 -Dappdynamics.agent.nodeName=$service1-node TestHelloWorld 8988 | tee $logFolder/helloworld.log
