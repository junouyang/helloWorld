...
$cmd -Dappdynamics.agent.applicationName=$4 -Dappdynamics.agent.tierName=$service3 \
-javaagent:/Users/jun.ouyang/source/helloWorld/lib/javaagent/$version/javaagent.jar \
-Dappdynamics.agent.nodeName=kakaka-node BackendService 8990 | tee $logFolder/backend3-8988.log & \
