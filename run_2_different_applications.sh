...
#parameter: hostname port applicationName applicationName accessKey version
...
-javaagent:/Users/jun.ouyang/source/helloWorld/lib/javaagent/$6/javaagent.jar"
...
echo $logFolder
mkdir $logFolder
$cmd -Dappdynamics.agent.applicationName=$3 -Dappdynamics.agent.tierName=$service2 \
-Dappdynamics.agent.nodeName=$service2-node BackendService 8988 | tee $logFolder/backend-8988.log & \
