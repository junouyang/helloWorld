 ...
 */
public class BackendServiceLoop2 extends HttpServlet {
    ...
    public BackendServiceLoop2(int port, boolean isLast) {
        this.port = port;
        this.isLast = isLast;
...
//        Server server1 = BackendServiceLoop2.start("bt1_end", 8988, true/*end of bt*/);
        Server server2 = BackendServiceLoop2.start("bt3_start", 8999, false /*not end of bt*/);
//        server1.join();
        server2.join();
    }
    ...
    public static Server start(String servletName, int port, boolean isLast) throws Exception {
        ...
        BackendServiceLoop2 backendService = new BackendServiceLoop2(port, isLast);
    ...
    public class SetSleepTime extends HttpServlet {
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            BackendServiceLoop2.this.sleepTime = Long.parseLong(request.getParameter("s"));
        }
    }

    public class SetRequestCount extends HttpServlet {
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            BackendServiceLoop2.this.requestCount = Integer.parseInt(request.getParameter("c"));
        }
    }
}
