...
$cmd -Dappdynamics.agent.tierName=$service2 -Dappdynamics.agent.nodeName=$service2-node BackendService 8988 true \
| tee $logFolder/backend-8988.log & \
$cmd -Dappdynamics.agent.tierName=$service1 -Dappdynamics.agent.nodeName=$service1-node1 TestHelloWorld 8988 \
| tee $logFolder/helloworld1.log & \
$cmd -Dappdynamics.agent.tierName=$service1 -Dappdynamics.agent.nodeName=$service1-node2 TestHelloWorld 8988 \
| tee $logFolder/helloworld2.log & \
$cmd -Dappdynamics.agent.tierName=$service1 -Dappdynamics.agent.nodeName=$service1-node3 TestHelloWorld 8988 \
| tee $logFolder/helloworld3.log