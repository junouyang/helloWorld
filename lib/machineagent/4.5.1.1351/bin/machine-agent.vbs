...
If arguments.Exists("-j") Then
    ...
    If Not fsObject.FileExists(java) Then
        errMsg = _
                ...
                "Please configure a valid JRE installation with version 1.7 or above or" & vbCrLf & _
...
Else
    errMsg = _
            ...
            "a bundled JRE or install a JRE with a version greater than or equal to 1.7" & vbCrLf & _
            "on your machine"
    WScript.Echo errMsg
    WScript.Quit
End If
