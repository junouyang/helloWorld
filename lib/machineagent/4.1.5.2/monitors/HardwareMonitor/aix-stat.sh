...
iostat -Dl 1 1 | awk -v OFS="" '
	...
	END {
print "name=Hardware Resources|Disks|KB read/sec,aggregator=OBSERVATION,value=", int(rk/1000);
print "name=Hardware Resources|Disks|KB written/sec,aggregator=OBSERVATION,value=", int(wk/1000);
print "name=Hardware Resources|Disks|Reads/sec,aggregator=OBSERVATION,value=", int(reads);
print "name=Hardware Resources|Disks|Writes/sec,aggregator=OBSERVATION,value=", int(writes);
	}
'
