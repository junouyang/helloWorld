...
-Dappdynamics.agent.reuse.nodeName.prefix=$6"

logFolder="logs/$5/"
service1="web"
service2="bookservice"
mkdir $logFolder
$cmd -Dappdynamics.agent.tierName=$service2  BackendService 8988 true \
| tee $logFolder/backend-8988.log & \
$cmd -Dappdynamics.agent.tierName=$service1  TestHelloWorld 8988 | tee $logFolder/helloworld.log
