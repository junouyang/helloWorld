...
-Dappdynamics.controller.keystore.password=arc-gateway-service \
-Dappdynamics.controller.keystore.filename=../../conf/cacerts \
...
$cmd -Dappdynamics.agent.tierName=$service3 -Dappdynamics.agent.nodeName=$service3-node BackendService 8989 \
